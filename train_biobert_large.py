...
for fold, (train_idx, val_idx) in enumerate(kf.split(texts), 1):
    ...
    training_args = TrainingArguments(
        ...
        learning_rate=1e-5,  # 全部微調需要更低學習率
        num_train_epochs=5,   # 全部微調容易過擬合，減少epochs
        weight_decay=0.1,     # 增加權重衰減防過擬合
        ...
        metric_for_best_model="eval_f1",  # 改用F1 score選擇最佳模型
